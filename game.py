import pygame
import random
from constants import WIDTH, HEIGHT, BLACK, FPS, PLAYER_HEALTH, BAT_FRAME_HEIGHT
from enemies.enemy import Enemy  # Only Enemy is in enemy.py
from enemies.ghost import Ghost  # Ghost is in ghost.py
from enemies.monster import Monster  # Monster is in monster.py
from objects.explosion import Explosion  # Explosion is in explosion.py
from objects.player import Player  # Import Player from player.py
from ui import Score, draw_level_number, HealthBar
from background import Background
from sound_manager import SoundManager
from screens import show_game_over_screen, show_game_win_screen
...
def run_game():
    ...
    while running:
        ...
        if score.value >= 500:
            show_game_win_screen(screen)
            running = False  # End the game loop once the player wins
